...
bool EPDGUI_Base::isSelected(void) { return _issel; }
...
void EPDGUI_Base::SetHide(bool ishide) { this->_ishide = ishide; }

void EPDGUI_Base::SetEnable(bool isenable) { this->_isenable = isenable; }
